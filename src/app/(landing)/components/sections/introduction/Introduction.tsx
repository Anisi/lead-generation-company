...
import Inner from '@/app/(landing)/components/sections/introduction/components/Inner';
import List from '@/app/(landing)/components/sections/introduction/components/List';
import ListItem from '@/app/(landing)/components/sections/introduction/components/ListItem';
